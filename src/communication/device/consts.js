...
export const DEVICE_EVENT_DISCONNECTED = 'axidraw-web-device-event-disconnected';

export const WEBSOCKET_STATUS_DISCONNECTED = 'axidraw-web-ws-status-disconnected';
